...
export default function SignUp() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#060b13] relative overflow-hidden">
      ...
      <Link href="/login" className="absolute top-4 right-4 text-white bg-green-500 rounded-full px-4 py-2 transition-all hover:bg-green-600 shadow-[0_0_15px_rgba(34,197,94,0.6)]">Home</Link>
